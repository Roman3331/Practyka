        ...
        <main className="p-8 space-y-8 overflow-y-auto">
          <div className="flex justify-between items-end">
            <div className="space-y-1">
              <h2 className="text-4xl font-black text-white uppercase tracking-tighter text-gradient">Навчальні Завдання</h2>
              <p className="text-slate-500 font-medium">Список всіх завдань з ваших предметів</p>
            </div>
